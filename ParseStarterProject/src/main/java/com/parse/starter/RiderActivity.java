...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
                                ...
                                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(RiderActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (lastKnownLocation != null) {
                                        ...
                                        if (distanceInKilometres < 0.01) {
                                            ...
                                            infoTextView.setText("Your Guide is here!");
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    callGuideButton.setVisibility(View.VISIBLE);
                                                    callGuideButton.setText("Request Guide");
                                                    requestActive = false;
                                                    driverActive = false;
                                            ...
                                            infoTextView.setText("Your Guide is " + distanceOneDP.toString() + " Kilometres away!");
                                            ...
                                            callGuideButton.setVisibility(View.INVISIBLE);
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                callGuideButton.setText("Cancel Guide");
                                requestActive = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callGuideButton = (Button) findViewById(R.id.callUberButton);
